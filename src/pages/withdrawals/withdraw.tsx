...
export const withdrawalMethodsArray: [string, string, string, string] = ['bkash', 'rocket', 'ucash', 'nogod']
    ...
    resolver: yupResolver(
      Yup.object({
        amount: Yup.number()
          ...
          .test('Insufficient Amount', "Oops, You don't have that much", (value) => value! <= balanceData?.balance)
          .required('Required'),
        method: Yup.string().oneOf(withdrawalMethodsArray, 'Invalid Payment Method Type').required('Required'),
        password: Yup.string().min(6, 'Password should be at least six characters').required('Required'),
        trxID: Yup.string()
        ...
        <main className="bg-white w-full mx-auto p-4 md:p-8 mt-5 rounded-lg shadow-2xl">
          <div className="mb-3 px-2 py-4 bg-gray-300 text-black rounded-lg">
            <p className="text-lg font-semibold">
              *** Withdrawal Amount will be transferred to your Verified Mobile Number.
            </p>
          </div>
