      ...
      {penaltyDataValue ? (
        <form onSubmit={handleSubmit}>
          <div className="flex mt-5">
            <SomeTable data={divideAnArrayIntoMultipleParts(data.penaltyData, 3)[0]} />
            <SomeTable data={divideAnArrayIntoMultipleParts(data.penaltyData, 3)[1]} />
            <SomeTable data={divideAnArrayIntoMultipleParts(data.penaltyData, 3)[2]} />
          </div>
