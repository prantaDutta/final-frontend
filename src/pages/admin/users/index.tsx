...
import { adminUsersPageState } from '../../../states/dropdownStates'
...
const VerificationRequests: React.FC<VerificationRequestsProps> = ({ user }) => {
  const [verified, setVerified] = useRecoilState(adminUsersPageState)
